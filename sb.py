...
botStart = time.time()
#cl = LINE("")
#cl = LINE("EQBsHevuak3gHr6a9AE6.MHCCzWaF2XUmO25oBo1rDG.e19a2/ddBm7TbozbYl1u3n1cFE6922MNAjWJd11P+ro=")
cl = LINE("bagask922@gmail.com","134645vybgs")
...
settings = {
    ...
    "autoRead": False,
    "lang":"JP",
    "commentPost": "LIKE & COMEN DONE \n Add my owner ID http://line.me/ti/p/~memekbasah25",
    "detectMention": True,
    ...
    data = {
            ...
            "contents": {
             ...
             "hero": {
               ...
               "action": {
                 "type": "uri",
                 "uri": "https://line.me/ti/p/~memekbasah25"
                 }
               },
                   "type": "bubble",
                   "body": {
...
def sendTextTemplateMaster(to, text):
  ...
  "styles": {
    ...
    "header": {
     ...
     "aspectRatio": "20:13",
     "aspectMode": "cover",
     "url": "https://i.ibb.co/MfLr9wc/1587209543203.jpg",
     "size": "full",
     "margin": "xl"
  },
  "footer": {
      ...
      "contents": [{
          ...
          "contents": [{
              ...
              "action": {
                  "type": "uri",
                  "label": "O",
                  "uri": "http://line.me/ti/p/~memekbasah25"
              }
          }, {
              "flex": 3,
              "type": "button",
...
def clBot(op):
  ...
  "contents": [
    {
      ...
      "body": {
        "contents": [
          ...
          {
            "type": "image",
        "url": "https://i.ibb.co/MfLr9wc/1587209543203.jpg", #hp
        "aspectRatio": "2:1",
        "aspectMode": "cover",
        "size": "full",
          },
            ...
            "contents": [
              {
                "contents": [
                  {
                    "text": "👁️ 𝑨𝒍𝒍𝒔𝒕𝒂𝒕𝒖𝒔 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑹𝒆𝒔𝒕𝒂𝒓𝒕\n👁️ 𝑵𝒐𝒕𝒊𝒇 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑺𝒊𝒅𝒆𝒓 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑨𝒖𝒕𝒐𝒂𝒅𝒅 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑨𝒖𝒕𝒐𝒋𝒐𝒊𝒏 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑨𝒖𝒕𝒐𝒍𝒆𝒂𝒗𝒆 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑨𝒖𝒕𝒐𝒓𝒆𝒂𝒅 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑪𝒉𝒆𝒄𝒌𝒔𝒕𝒊𝒄𝒌𝒆𝒓 (𝑶𝒏/𝑶𝒇𝒇)\n👁️ 𝑫𝒆𝒕𝒆𝒄𝒕𝒎𝒆𝒏𝒕𝒊𝒐𝒏 (𝑶𝒏/𝑶𝒇𝒇)",
                    "size": "xxs",
                    "margin": "none",
                    "color": "#FF1493",
                    "wrap": True,
            ...
            "contents": [
              {
                "contents": [
                  {
                    "text": "👁️ 𝑴𝒑4 𝒋𝒖𝒅𝒖𝒍\n👁️ 𝑴𝒕𝒐𝒉 (𝒕𝒈𝒍/𝒃𝒍𝒏/𝒕𝒉𝒏)\n👁️ 𝑲𝒂𝒍𝒆𝒏𝒅𝒆𝒓\n👁️ 𝒀𝒐𝒖𝑻𝒖𝒃𝒆 𝒋𝒖𝒅𝒖𝒍\n👁️ 𝑨𝒔𝒎𝒂𝒖𝒍𝒉𝒖𝒔𝒏𝒂 𝒏𝒐 1-99\n👁️ 𝑺𝒎𝒖𝒍𝒆 𝒊𝒅𝒔𝒎𝒖𝒍𝒆\n👁️ 𝒀𝒕𝒔𝒆𝒂𝒓𝒄𝒉 𝒋𝒖𝒅𝒖𝒍\n👁️ 𝑴𝒑3 𝒋𝒖𝒅𝒖𝒍\n👁️ 𝑨𝒍-𝑸𝒖𝒓𝒂𝒏 𝒏𝒐𝒎𝒐𝒓 1-114\n👁️ 𝑨𝒚𝒂𝒕 𝒔𝒂𝒋𝒂𝒅𝒂𝒉",
                    "size": "xxs",
                    "margin": "none",
                    "color": "#FF1493",
                    "wrap": True,
  ...
  "type": "carousel"
                           ...
                           cl.postFlex(to, data)
                            ...
                            if len(count) == 1:
                                ...
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"𝑮𝒐𝒍𝒅𝒆𝒏 𝑺𝒊𝒏𝒈 𝑺𝒎𝒖𝒍𝒆 (𝑮𝑺2)")
                    ...
                    sendTextTemplate(to, "𝑴𝒆𝒏𝒈𝒉𝒂𝒑𝒖𝒔 𝑲𝒆𝒏𝒂𝒏𝒈𝒂𝒏")
                    ...
                    sendTextTemplate(to, "𝑪𝑳𝑩𝑲 𝒅𝒊𝒎𝒖𝒍𝒂𝒊...")
                    restartBot()
                    ...
                    try:
                        arr = []
                        owner = "u9a171c67001fdb1b8ca36e4e6ced5176"
                        ...
                        ret_ += "\n╠ Version : Free v 1.1 by 𝑽𝒚𝑩𝒈𝒔"
                        ret_ += "\n╠ Creator : {}".format(creator.displayName)
                        ret_ += "\n╚ 𝑮𝒐𝒍𝒅𝒆𝒏 𝑺𝒊𝒏𝒈 𝑺𝒎𝒖𝒍𝒆 (𝑮𝑺2)"
                    ...
                    sendTextTemplate(to, "𝑺𝒊𝒂𝒑 𝒘𝒊𝒌-𝒘𝒊𝒌 𝒋𝒊𝒌𝒂 𝒅𝒊𝒂𝒋𝒂𝒌")
                elif text.lower() == 'autojoin off':
                    settings["autoJoin"] = False
                    sendTextTemplate(to, "𝑨𝒖𝒕𝒐 𝑱𝒐𝒊𝒏 𝑶𝒇𝒇")
                elif text.lower() == 'autoleave on':
                    settings["autoLeave"] = True
                    sendTextTemplate(to, "𝑺𝒊𝒂𝒑 𝑪𝒓𝒐𝒕-𝑪𝒓𝒐𝒕")
                elif text.lower() == 'autojoin off':
                    settings["autoLeave"] = False
                    sendTextTemplate(to, "𝑨𝒖𝒕𝒐 𝑳𝒆𝒂𝒗𝒆 𝑶𝒇𝒇")
                elif text.lower() == 'autoread on':
                    settings["autoRead"] = True
                    sendTextTemplate(to, "𝑺𝒊𝒂𝒑 𝒍𝒊𝒉𝒂𝒕 𝑴𝒆𝒎𝒆𝒌")
                elif text.lower() == 'autoread off':
                    settings["autoRead"] = False
                    sendTextTemplate(to, "𝑨𝒖𝒕𝒐 𝑹𝒆𝒂𝒅 𝑶𝒇𝒇")
                elif text.lower() == 'checksticker on':
                    settings["checkSticker"] = True
                    sendTextTemplate(to, "𝑪𝒉𝒆𝒄𝒌 𝑫𝒆𝒕𝒂𝒊𝒍𝒔 𝑺𝒕𝒊𝒄𝒌𝒆𝒓 𝑶𝒏")
                elif text.lower() == 'checksticker off':
                    settings["checkSticker"] = False
                    sendTextTemplate(to, "𝑪𝒉𝒆𝒄𝒌 𝑫𝒆𝒕𝒂𝒊𝒍𝒔 𝑺𝒕𝒊𝒄𝒌𝒆𝒓 𝑶𝒇𝒇")
                elif text.lower() == 'responsticker on':
                    settings["responsticker"] = True
                    sendTextTemplate(to, "𝑻𝒆𝒎𝒑𝒍𝒂𝒕𝒆 𝑺𝒕𝒊𝒄𝒌𝒆𝒓 𝑶𝒏")
                elif text.lower() == 'responsticker off':
                    settings["responsticker"] = False
                    sendTextTemplate(to, "𝑻𝒆𝒎𝒑𝒍𝒂𝒕𝒆 𝑺𝒕𝒊𝒄𝒌𝒆𝒓 𝑶𝒇𝒇")
                elif text.lower() == 'detectmention on':
                    settings["datectMention"] = True
                    sendTextTemplate(to, "𝑫𝒆𝒕𝒆𝒄𝒕 𝑴𝒆𝒏𝒕𝒊𝒐𝒏 𝑶𝒏")
                elif text.lower() == 'detectmention off':
                    settings["datectMention"] = False
                    sendTextTemplate(to, "𝑫𝒆𝒕𝒆𝒄𝒕 𝑴𝒆𝒏𝒕𝒊𝒐𝒏 𝑶𝒇𝒇")
                    ...
                    settings["autoRead"] = True
                    settings["datectMention"] = True
                    sendTextTemplate(to, "𝑴𝒐𝒅𝒆 𝑻𝒆𝒍𝒂𝒏𝒋𝒂𝒏𝒈 𝒃𝒖𝒍𝒂𝒕")
                    ...
                    settings["autoRead"] = False
                    settings["datectMention"] = False
                    sendTextTemplate(to, "𝑨𝒍𝒍𝒔𝒕𝒂𝒕𝒖𝒔 𝒃𝒐𝒕 𝒎𝒐𝒅𝒆 𝑶𝒇𝒇")
                    ...
                    if 'MENTION' in msg.contentMetadata.keys()!= None:
                        ...
                        try:
                            ...
                            sendTextTemplate(msg.to, "𝑶𝒓𝒂𝒏𝒈𝒏𝒚𝒂 𝒔𝒖𝒅𝒂𝒉 𝒔𝒂𝒚𝒂 𝒌𝒆𝒍𝒐𝒏.𝒋𝒂𝒅𝒊 𝒈𝒂𝒌 𝒔𝒂𝒏𝒈𝒆 𝒍𝒂𝒈𝒊 𝒅𝒊𝒂.")
                        except:
                            sendTextTemplate(msg.to, "𝑶𝒓𝒂𝒏𝒈𝒏𝒚𝒂 𝒈𝒂𝒌 𝒎𝒂𝒖 𝒅𝒊𝒂𝒋𝒂𝒌 𝒌𝒆𝒍𝒐𝒏")
      ...
      "contents": [{
                  ...
                  "uri": search_url
                    ...
                    if msg.toType == 2:
                             ...
                             for x in range(jmlh):
                                 ...
                                 print(link)
                                 sendTextTemplate(msg.to,"login link itu")
                                 ...
                                 sendTextTemplate(msg.to, "oke by 𝑽𝒚𝑩𝒈𝒔")
                   ...
                   if settings["notifikasi"] == False:
                    ...
                    if msg.to in read['readPoint']:
                        ...
                        with open('read.json', 'w') as fp:
                            json.dump(read, fp, sort_keys=True, indent=4)
                            sendTextTemplate(msg.to, "𝑺𝒆𝒕 𝒓𝒆𝒂𝒅𝒊𝒏𝒈 𝒑𝒐𝒊𝒏𝒕:\n" + readTime)
                    ...
                    if msg.to in read["readPoint"]:
                        ...
                        sendTextTemplate(msg.to, "𝑳𝒖𝒓𝒌𝒊𝒏𝒈 𝒃𝒆𝒍𝒖𝒎 𝒉𝒊𝒅𝒖𝒑 𝒈𝒐𝒃𝒍𝒐𝒌😡𝑯𝒊𝒅𝒖𝒑𝒊𝒏 𝒅𝒖𝒍𝒖!!!𝑮𝒐𝒃𝒍𝒐𝒌 𝒅𝒊 𝒑𝒆𝒍𝒊𝒉𝒂𝒓𝒂")
                    ...
                    if receiver in read['readPoint']:
                        ...
                        sendTextTemplate(receiver,"𝑯𝒊𝒅𝒖𝒑𝒊𝒏 𝒅𝒖𝒍𝒖 𝒍𝒖𝒓𝒌𝒊𝒏𝒈 𝒏𝒚𝒂 𝒑𝒆𝒂😡😡😡𝒉𝒂𝒅𝒆𝒆𝒆𝒉")
                    ...
                    settings["Sider"] = True
                    sendTextTemplate(msg.to,"𝑴𝒆𝒎𝒆𝒌 𝒔𝒖𝒅𝒂𝒉 𝒃𝒂𝒔𝒂𝒉,𝒔𝒊𝒂𝒑 𝒘𝒊𝒌 𝒘𝒊𝒌 (𝑺𝒊𝒅𝒆𝒓 𝑶𝒏)")

                elif text.lower() == 'sider off':
                    if msg.to in cctv['point']:
                       cctv['cyduk'][msg.to]=False
                       settings["Sider"] = False
                       sendTextTemplate(msg.to,"𝑴𝒆𝒎𝒆𝒌 𝒔𝒖𝒅𝒂𝒉 𝒌𝒆𝒓𝒊𝒏𝒈,𝒕𝒊𝒅𝒂𝒌 𝒃𝒊𝒔𝒂 𝒘𝒊𝒌 𝒘𝒊𝒌 (𝑺𝒊𝒅𝒆𝒓 𝑶𝒇𝒇)")
                    else:
                        sendTextTemplate(msg.to,"𝑴𝒆𝒎𝒆𝒌 𝒔𝒖𝒅𝒂𝒉 𝒌𝒆𝒓𝒊𝒏𝒈,𝒕𝒊𝒅𝒂𝒌 𝒃𝒊𝒔𝒂 𝒘𝒊𝒌 𝒘𝒊𝒌 (𝑺𝒊𝒅𝒆𝒓 𝑶𝒇𝒇)")
            ...
            if msg.toType == 0:
                ...
                if msg.contentType == 16:
                    if msg.toType in (2,1,0):
                        ...
                        sendTextTemplate(to, "𝑼𝒔𝒂𝒉𝒂𝒌𝒂𝒏 𝒖𝒏𝒕𝒖𝒌 𝒕𝒆𝒕𝒂𝒑 𝒅𝒊𝒓𝒖𝒎𝒂𝒉,𝒖𝒏𝒕𝒖𝒌 𝒎𝒆𝒏𝒈𝒉𝒊𝒏𝒅𝒂𝒓𝒊 𝒑𝒆𝒏𝒚𝒆𝒃𝒂𝒓𝒂𝒏 𝒄𝒐𝒗𝒊𝒅-19")
        ...
        if op.type == 17:
           ...
           if settings["notifikasi"] == True:
             ...
             data = {
                                "type": "flex",
                                "altText": "𝑨𝒅𝒂 𝒚𝒂𝒏𝒈 𝒎𝒂𝒔𝒖𝒌 𝒈𝒖𝒚𝒔,𝒂𝒚𝒐 𝒕𝒊𝒌𝒖𝒏𝒈",
                                "contents": {
  "styles": {
    "body": {
      "backgroundColor": "#7D00C1"
    ...
    "contents": [
      {
        "contents": [
          {
            "text":" 𝑺𝒆𝒍𝒂𝒎𝒂𝒕 𝒅𝒂𝒕𝒂𝒏𝒈 \n 𝒅𝒂𝒏 𝒔𝒆𝒍𝒂𝒎𝒂𝒕 𝒃𝒆𝒓𝒈𝒂𝒃𝒖𝒏𝒈\n𝑩𝒖𝒅𝒂𝒚𝒂𝒌𝒂𝒏 𝑵𝒊𝒌𝒖𝒏𝒈💘\n𝑱𝒂𝒏𝒈𝒂𝒏 𝑺𝒂𝒏𝒈𝒆🤪 ".format(cl.getContact(op.param2).displayName),
            "size": "xxs",
            "color": "#00FF00",
            "wrap": True,
            "type": "text",
      ...
      "contents": [{
        ...
        if op.type == 15:
           ...
           if settings["notifikasi"] == True:
             ...
             data = {
                                "type": "flex",
                                "altText": "𝒂𝒅𝒂 𝒚𝒂𝒏𝒈 𝒌𝒆𝒍𝒖𝒂𝒓 𝒈𝒖𝒚𝒔,𝒂𝒚𝒐 𝒌𝒊𝒕𝒂 𝒌𝒆𝒋𝒂𝒓",
                                "contents": {
  "styles": {
    "body": {
      "backgroundColor": "#7D00C1"
    ...
    "contents": [
      {
        "contents": [
          {
            "text":"𝑵𝒂𝒉 𝒔𝒊𝒂𝒑𝒂 𝒚𝒂𝒏𝒈 𝒃𝒊𝒌𝒊𝒏 𝒅𝒊𝒂 𝑺𝒂𝒏𝒈𝒆?\n\n𝑺𝒖𝒅𝒂𝒉 𝒌𝒖𝒃𝒊𝒍𝒂𝒏𝒈 𝒋𝒂𝒏𝒈𝒂𝒏 𝑺𝒂𝒏𝒈𝒆\n\n{}".format(cl.getContact(op.param2).displayName),
            "size": "xxs",
            "color": "#00FF00",
            "wrap": True,
            "type": "text",
